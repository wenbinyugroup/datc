...
def parseAbaqusInput(abq_inp_name):
    ...
    e_connt_2d = {3: e_connt_2d3, 4: e_connt_2d4,
                  6: e_connt_2d6, 8: e_connt_2d8}
    e_connt_3d = {4: e_connt_3d4, 8: e_connt_3d8,
                  10: e_connt_3d10, 20: e_connt_3d20}
    ...
    # print elsets
    # print n_coord.shape
    # n_coord_t = np.transpose(n_coord)
    # print n_coord_t.shape
    # print n_coord[:10, 2]
    # print n_coord_t[2, :10]
    # print n_coord[:, 2].shape
    # print n_coord[2, :].shape
    # print np.amax(n_coord, axis=0)
    return {
        'nsg': nsg,
        'nodes': n_coord,
