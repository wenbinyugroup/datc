...
def createSCInputMain(
    ...
    print 'Parsing data from Abaqus input...'
    ...
    print 'Reorganizing data for SwfitComp input...'
    results = reorgAbaqusInput(
        nsg, macro_model, nodes, elements2d, elements3d, elsets,
