...
class ParaDirLHS_plugin(AFXForm):
    ...
    def __init__(self, owner):
        ...
        self.NumsampleKw = AFXStringKeyword(self.cmd, 'Numsample', True, '10')
    ...
    def getFirstDialog(self):
        ...
        import ParaDirDB_lhs
        return ParaDirDB_lhs.ParaDirDB_lhs(self)
...
toolset.registerGuiMenuButton(buttonText='ATC|4.Parametric study|2.Latin hypercube sampling',
        object=ParaDirLHS_plugin(toolset),
